...
## Corpus Check
- 5 files · ~20,396 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 69 nodes · 66 edges · 8 communities (7 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5ccb034e`
...
4. `Core screens` - 7 edges
5. `2. Results explorer` - 5 edges
6. `8. Desired user-facing features` - 5 edges
7. `3. Map view` - 4 edges
8. `4. Event detail` - 3 edges
9. `Application shell` - 3 edges
10. `Initial MVP scope` - 3 edges
...
### Community 0 - "2. Results explorer"
Cohesion: 0.40
...
## Knowledge Gaps
- **50 isolated node(s):** `graphify`, `Event cards`, `Filters`, `Shareable state`, `Sort options` (+45 more)
...
- **Why does `Core screens` connect `Core screens` to `2. Results explorer`, `ParkMatch NYC — Initial Frontend Direction`, `3. Map view`?**
...
- **What connects `graphify`, `Event cards`, `Filters` to the rest of the system?**
...
- **Should `419495f4-0ca6-4d45-b6e3-43e1e35536d5 implementation handoff` be split into smaller, more focused modules?**
  _Cohesion score 0.14285714285714285 - nodes in this community are weakly interconnected._