...
This archive is the source of truth for turning the design into production code. Start from `nyc-events-mvp-v2.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `nyc-events-mvp-v2.html`
...
- A single self-contained `nyc-events-mvp-v2.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `nyc-events-mvp-v2.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `nyc-events-mvp-preview.png`

## Coding checklist for AI tools
1. Inspect `nyc-events-mvp-v2.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
